<template>
  <div class="page">
    <Header />
    <Navigation current-path="top" :nav-categories="navCategories" />
    <main>
      <ModuleTabs current-path="top" />
      <h1 class="title-h2 module-page-title"><i class="icon-top"></i>TOP GAMES</h1>
      <!-- 当前分类游戏列表 -->
      <section class="box-module box-module-tabs-margin">
        ...
        <!-- top-1: Google Ad 占位 1 -->
        <GoogleAd ad-slot="1969405138" class="ad1" />
        <!-- top-2: Google Ad 占位 2 -->
        <GoogleAd ad-slot="3383060164" class="ad2" />
      </section>
