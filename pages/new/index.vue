<template>
  <div class="page">
    <Header />
    <Navigation current-path="new" :nav-categories="navCategories" />
    <main>
      <ModuleTabs current-path="new" />
      <h1 class="title-h2 module-page-title"><i class="icon-latest"></i>NEW GAMES</h1>
      <!-- 当前分类游戏列表 -->
      <section class="box-module box-module-tabs-margin">
        ...
        <GoogleAd ad-slot="1021540575" class="ad1" />
        <!-- new-2: Google Ad 占位 2 -->
        <GoogleAd ad-slot="9756896824" class="ad2" />
      </section>
