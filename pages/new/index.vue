<template>
  <div class="page">
    ...
    <main class="main">
      <div class="main-left">
        <h2 class="title-h2"><i class="icon-new" />Latest</h2>
        <!-- <GoogleAd ad-slot="4363167594" class="ad1 ad-width" /> -->
        <adm-slot
          class="ad1 ad-width"
          adm-id="new-mid1"
        ...
        <!-- <GoogleAd ad-slot="5676249263" class="ad2 ad-width" /> -->
        <adm-slot
          class="ad2 ad-width"
          adm-id="new-mid2"
        ...
        <aside class="box-aside">
          <!-- <GoogleAd ad-slot="4746502868" /> -->
          <adm-slot adm-id="new-mid3" adm-unit="/23197833490/alltools1/alltools1_module_3" />
...
export default {
  async asyncData({ $axios, env }) {
    try {
      const [newsResponse, recGamesResponse, allGamesResponse] = await Promise.all([
