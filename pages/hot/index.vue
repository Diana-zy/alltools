<template>
  <div class="page">
    <Header />
    <Navigation current-path="hot" :nav-categories="navCategories" />
    <main>
      <ModuleTabs current-path="hot" />
      <h1 class="title-h2 module-page-title"><i class="icon-popular"></i>HOT GAMES</h1>
      <!-- 当前分类游戏列表 -->
      <section class="box-module box-module-tabs-margin">
        ...
        <GoogleAd ad-slot="7030160127" class="ad1" />
        <!-- hot-2: Google Ad 占位 2 -->
        <GoogleAd ad-slot="9082109405" class="ad2" />
      </section>
